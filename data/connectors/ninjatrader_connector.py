"""NinjaTrader connector placeholder."""
...
class NinjaTraderConnector(DataConnector):
    """Placeholder connector for NinjaTrader CSV/ATI integration."""

    _available = False

    async def connect(self) -> bool:
        self._mark_connected(False)
        self._record_error("NinjaTrader connector requires platform-specific integration")
        return False
    ...
    async def ping(self) -> float:
        raise RuntimeError("NinjaTrader connector unavailable")
