...
class FXProConnector(DataConnector):
    """Placeholder connector for FXPro REST/WS integration."""

    _available = False

    async def connect(self) -> bool:
        self._mark_connected(False)
        self._record_error("FXPro connector requires account-specific API integration")
        return False
    ...
    async def ping(self) -> float:
        raise RuntimeError("FXPro connector unavailable")
